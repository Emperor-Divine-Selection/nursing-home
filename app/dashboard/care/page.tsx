import { getAllCareRecords } from "@/actions/careRecords"
...
import CareRecordClient from "@/components/CareRecords/CareRecordsClient";
...
export default async function Care() { 
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <CareRecordClient caregiversList={caregiversList.data ?? []} eldersList={eldersList.data ?? []} />
    </div>
  )
}